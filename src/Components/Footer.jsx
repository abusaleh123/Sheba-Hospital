                ...
                <footer className="relative   footer sm:footer-horizontal w-9/12 mx-auto text-[#ffffff] p-10 py-20">
                 ...
                 <div className=' w-3/12'>
                        ...
                        <p className='text-[#EBEBEB] mb-9'>
                            The Online Seba Hospital has all the characteristics of a world-class hospital, including a wide range of services and specialists.
                        </p>

                        {/* Socials */}
                        <div className="flex gap-5">
                            <p className="text-white border p-2 rounded-full"><RiFacebookFill className="text-xl" /></p>
                            <p className="text-white border p-2 rounded-full"><FaInstagram className="text-xl" /></p>
                            <p className="text-white border p-2 rounded-full"><PiLinkedinLogoBold className="text-xl" /></p>
                            <p className="text-white border p-2 rounded-full"><RiYoutubeLine className="text-xl" /></p>
                        </div>
                    </div>
                    <div className=' w-3/12 text-[#EBEBEB]'>
                        <h6 className=" font-bold text-2xl text-[#FFFFFF]">Departments</h6>
