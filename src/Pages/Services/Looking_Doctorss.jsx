...
const Looking_Doctors = () => {
    return (
        <div className='service-linearr mt-25 mb-25'>
            {/* Main Container */}
          <div    style={{
    ...
    <p className="mt-6 text-[#FFFFFFCC]/80 w-3/4">The Seba Hospital has all the characteristics of a world-class hospital, including a wide range of services </p>
          </div>
          {/* Button Container */}
          <div>
