...
<h1 className="text-4xl text-[#032D63]">Our <span className='font-extrabold'>Doctors</span></h1>
<p className="text-[#858585] mt-4">The Online Seba Hospital has all the characteristics</p>
     ...
     <button className="btn btn-ghost bg-[#032D63]  text-lg text-white rounded-md px-6 py-6">See All Doctors List</button>
     </div>
    </div>
  );
};
